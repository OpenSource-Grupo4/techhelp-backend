package com.upc.techelp.platform.iam.interfaces.rest;

import com.upc.techelp.platform.iam.domain.services.UserCommandService;
...
import com.upc.techelp.platform.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.upc.techelp.platform.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.upc.techelp.platform.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
import com.upc.techelp.platform.iam.interfaces.rest.transform.UserResourceFromEntityAssembler;
import com.upc.techelp.platform.repairing.domain.model.queries.GetTechnicalByIdQuery;
import com.upc.techelp.platform.repairing.domain.services.TechnicalCommandService;
import com.upc.techelp.platform.repairing.domain.services.TechnicalQueryService;
...
import com.upc.techelp.platform.repairing.interfaces.rest.transform.CreateTechnicalFromResourceAssembler;
import com.upc.techelp.platform.repairing.interfaces.rest.transform.TechnicalResourceFromEntityAssembler;
